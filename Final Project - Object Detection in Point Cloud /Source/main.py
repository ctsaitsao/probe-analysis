...
read_file("final_project_data/final_project_point_cloud.fuse")
...
point_cloud.colors = o3d.utility.Vector3dVector(intensities)
o3d.io.write_point_cloud("./results.ply", point_cloud)
o3d.visualization.draw_geometries([point_cloud])
